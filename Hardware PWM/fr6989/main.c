/*
 * Hardware PWM program for MSP430FR6989
...
//use P1.0 (PWM pin) for led0; define generic names for gpio registers and gpio pin
#define LED0_DIR_R P1DIR
#define LED0_OUT_R P1OUT
#define LED0_SEL_R P1SEL0
#define LED0_PIN 0

//use P9.7 for led1; define generic names for gpio registers and gpio pin
#define LED1_DIR_R P9DIR
#define LED1_OUT_R P9OUT
#define LED1_PIN 7
